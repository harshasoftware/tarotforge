          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                Your premium membership is now active. You can start enjoying all the premium features immediately:
              </p>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-2">Priority access to certified readers</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <Check className="h-4 w-4 text-success" />
                  </div>
                  <span className="ml-2">Unlimited reading history</span>
                </li>
              </ul>
            </div>
