...
export const readingLayouts: ReadingLayout[] = [
  ...
  },
  {
    ...
    positions: [
      ...
      { id: 6, name: 'Self', meaning: 'How you view yourself', x: 75, y: 70 },
      { id: 7, name: 'Environment', meaning: 'How others view you or your environment', x: 75, y: 55 },
      { id: 8, name: 'Hopes/Fears', meaning: 'Your hopes and fears', x: 75, y: 40 },
      { id: 9, name: 'Outcome', meaning: 'The final outcome', x: 75, y: 25 }
    ]
  },
  {
    id: 'free-layout',
