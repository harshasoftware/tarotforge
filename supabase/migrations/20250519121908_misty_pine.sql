/*
  # Add full_name to users table and adjust triggers
  
  1. Changes:
    - Add full_name column to users table
    - Update trigger function to include full_name
  2. Security:
...
-- Create validate deck creator trigger function if not exists
-- This was in the prior version of the schema
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'validate_deck_creator') THEN
