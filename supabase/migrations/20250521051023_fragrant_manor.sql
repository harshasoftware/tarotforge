/*
  # Fix credit initialization on subscription changes

  1. New Functions
    - `initialize_subscription_credits` - Function to initialize or update credits when a subscription changes
  
  2. Database Triggers
    - `subscription_credits_trigger` - Trigger to initialize/update credits when subscription status changes
  
  3. RLS Policies
    - Update view permissions on user_credits table
*/
