/*
  # Credit System for AI Tarot App
  
  1. New Tables
    - `user_credits` - Stores user credit information and transactions
    - `credit_transactions` - Records all credit transactions
  2. Changes
    - Add credit-related columns to subscription view
  3. Security
